...
const About = ({ textEnter, textLeave, onMouseEnter, onMouseLeave }) => {
  return (
    <StyledContainer>
      <Content>
        <ImgContainer><img src={SunriseSrc} /></ImgContainer>
        <Text>
          <h2>Formidling av eiendom <br/> på solens kyst</h2>
          <p>
          ...
          Med vår eksklusive
            ...
            hjertelig velkomne til dette fantastiske området som omtales som
            «The Real Spain» og «A Place In The Sun».
          </p>
          <Button>Se områder</Button>
        </Text>
      </Content>
    </StyledContainer>
  );
